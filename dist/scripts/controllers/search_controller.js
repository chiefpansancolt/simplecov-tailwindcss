...
export default class extends Controller {
  ...
  initialize() {
    ...
    this.currentSearchValue = url.searchParams.get("q")
      ? url.searchParams.get("q")
      : ""
    this.currentSortOrderValue = url.searchParams.get("o")
  ...
  sort() {
    ...
    let list = Array.from(
      document.getElementById(this.currentViewValue + "-list").children
    ).filter((item) => item.id != this.currentViewValue + "-hideListItem")
